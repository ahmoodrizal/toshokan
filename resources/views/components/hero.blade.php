<section class="bg-gray-700 bg-center bg-no-repeat bg-cover bg-hero-background bg-blend-multiply">
    <div class="max-w-screen-xl px-4 py-48 mx-auto text-center lg:py-72">
        ...
        <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">by reading you can find out about
            various things that exist in this world
        </p>
        <div class="flex flex-col items-center space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
            <a href="#popular"
                class="px-5 py-2.5 text-sm font-medium text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 rounded-lg text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">Explore
                Now</a>
        </div>
    </div>
</section>
